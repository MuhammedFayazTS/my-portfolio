...
const BlogCardList: React.FC<BlogCardListProps> = ({ blogs, limit }) => {
    return (
        <>
            ...
            <Link href={'/blogs'} className='mt-8 text-center inline-flex justify-center items-center gap-x-1 text-gray-300 hover:text-blue-500'>
                View More
