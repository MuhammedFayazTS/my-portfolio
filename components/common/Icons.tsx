...
const iconColors: Record<iconName, string> = {
    ...
    postgresql: "text-sky-700",
    express: "text-gray-700 dark:text-gray-300",
    html: "text-orange-600",
    css: "text-blue-500",
    sequelize: "text-blue-400",
    github: "text-black dark:text-white",
    linkedin: "text-blue-600",
    mail: "text-red-500",
    socket: "text-gray-700 dark:text-gray-300",
    "peer-2-peer": "text-purple-500",
    mui: "text-blue-500",
    react: "text-[#61DAFB]",
...
export function Icon({ iconName, className = "", ...props }: IconProps) {
    const icons = {
        ...
        node: (
            <svg
                ...
                {...props}
            >
                <path fill="currentColor" d="M10.639 24h-.003c-.339 0-.656-.091-.928-.251l.009.005l-2.937-1.737c-.438-.246-.224-.332-.08-.383a5.8 5.8 0 0 0 1.352-.618l-.024.014a.23.23 0 0 1 .219.018l-.001-.001l2.256 1.339a.29.29 0 0 0 .274-.001l-.002.001l8.794-5.077a.28.28 0 0 0 .134-.238V6.922a.28.28 0 0 0-.136-.239l-.001-.001l-8.791-5.072a.28.28 0 0 0-.272.001l.001-.001l-8.789 5.073a.28.28 0 0 0-.139.24v10.149c0 .101.055.188.137.234l.001.001l2.41 1.392c1.307.654 2.107-.116 2.107-.889V7.788c0-.14.114-.254.254-.254h1.119c.14 0 .254.113.254.254V17.81c0 1.745-.95 2.746-2.604 2.746l-.066.001a3.75 3.75 0 0 1-1.976-.56l-2.29-1.318a1.86 1.86 0 0 1-.922-1.605V6.923C0 6.243.367 5.65.913 5.328l.009-.005L9.717.241a1.92 1.92 0 0 1 1.858.005l-.01-.005l8.794 5.082c.555.327.921.92.923 1.6v10.15a1.86 1.86 0 0 1-.915 1.6l-.009.005l-8.792 5.078a1.8 1.8 0 0 1-.922.246h-.007z" /><path fill="currentColor" d="M13.356 17.009c-3.848 0-4.655-1.766-4.655-3.249v-.001c0-.14.113-.253.253-.253h1.14c.127 0 .232.093.252.214v.001c.171 1.158.683 1.742 3.01 1.742c1.853 0 2.64-.419 2.64-1.402c0-.567-.223-.987-3.102-1.269c-2.406-.24-3.894-.77-3.894-2.695c0-1.774 1.496-2.833 4-2.833c2.818 0 4.212.978 4.388 3.076l.001.022a.254.254 0 0 1-.254.254h-1.133a.25.25 0 0 1-.246-.198v-.002c-.274-1.218-.94-1.607-2.746-1.607c-2.023 0-2.258.705-2.258 1.232c0 .64.278.826 3.009 1.187c2.702.358 3.986.863 3.986 2.762c-.004 1.919-1.601 3.017-4.388 3.017z" />
            </svg>
        ),
        typescript: (
            <svg
    ...
    const colorClass = iconColors[iconName] || "";
